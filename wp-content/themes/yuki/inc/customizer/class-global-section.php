...
if ( !class_exists( 'Yuki_Global_Section' ) ) {
    class Yuki_Global_Section extends CustomizerSection
    {
        ...
        {
            return [ ( new Repeater( 'yuki_social_networks' ) )->setLabel( __( 'Social Networks', 'yuki' ) )->setTitleField( "<%= settings.label %>" )->setLimit( 4, yuki_upsell_info( __( 'Add more social networks in %sPro Version%s', 'yuki' ) ) )->setDefaultValue( [ [
                'visible'  => true,
                'settings' => [
                'color' => [
                'official' => '#557dbc',
